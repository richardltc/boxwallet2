...
#
#     PHX_SERVER=true bin/boxwallet start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :boxwallet, BoxwalletWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  secret_file = Path.join([System.get_env("RELEASE_ROOT", "."), "secret_key_base.txt"])
  ...
  secret_key_base =
    if File.exists?(secret_file) do
      ...
      IO.puts("Generated new secret key at: #{secret_file}")
      secret
    end
  ...
  #
  #     config :boxwallet, Boxwallet.Mailer,
