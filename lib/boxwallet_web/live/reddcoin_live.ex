defmodule BoxwalletWeb.ReddCoinLive do
  ...
  def handle_info(:fetch_receive_address, socket) do
    fetch_address(socket, &ReddCoin.get_receive_address/1)
  end

  def handle_info(:new_receive_address, socket) do
    fetch_address(socket, &ReddCoin.get_new_address/1)
  end
  ...
  def handle_event("confirm_toggle_testnet", _params, socket) do
    ...
    conf_file = ReddCoin.get_conf_file_location()
  ...
  def render(assigns) do
    ...
    <!-- Error alert -->
      ...
      <div class="flex justify-center items-start gap-4">
        <.coin_sidebar color="text-rddred" active_tab={@active_tab} />
